                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2 rounded-md border p-3">
                      <label className="flex cursor-pointer items-center gap-2 text-sm font-medium">
                        <input type="checkbox" checked={hasDocumentsAll} onChange={() => toggleScope('documents:read')} className="rounded" />
                        All content types
                      </label>
                      {!hasDocumentsAll && ctList.length > 0 && (
                        <div className="ml-5 space-y-1 border-l pl-3">
                          {ctList.map((contentType) => {
                            const scope = `documents:read:${contentType.Slug}`;
                            return (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="space-y-2 rounded-md border p-3">
                      ...
                      <label className="flex cursor-pointer items-center gap-2 text-sm">
                        <input type="checkbox" checked={selectedScopes.includes('content-types:read')} onChange={() => toggleScope('content-types:read')} className="rounded" />
